...
class InventoryViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.product_2 = Product.objects.create(code="4567", origin_name="Hradna svieca", price=1.20, is_wine=True)
        self.ID_2 = str(self.product_2.id)
        self.wine = Wine.objects.create(product=self.product_2, year=2012, attribute="SW",
                                        acidity="12.23 ph", locality="Nitra")
